...
namespace _3D_Engine
{
    public sealed class Distant_Light : Light
    {
        ...
        internal override void Calculate_Light_View_Clipping_Planes()
        {
            ...
            Vector3D near_bottom_right_point = new Vector3D(semi_width, -semi_height, shadow_map_z_near);
            ...
            Vector3D far_top_left_point = new Vector3D(-semi_width, semi_height, shadow_map_z_far);
