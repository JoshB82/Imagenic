...
namespace _3D_Engine
{
    public class Perspective_Camera : Camera
    {
        ...
        internal override void Calculate_Camera_View_Clipping_Planes()
        {
            ...
            Vector3D far_top_right_point = new Vector3D(semi_width * z_ratio, semi_height * z_ratio, z_far);
            Vector3D far_bottom_left_point = new Vector3D(-semi_width * z_ratio, -semi_height * z_ratio, z_far);
