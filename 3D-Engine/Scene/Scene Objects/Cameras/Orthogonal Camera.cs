...
namespace _3D_Engine
{
    public class Orthogonal_Camera : Camera
    {
        ...
        internal override void Calculate_Camera_View_Clipping_Planes()
        {
            ...
            Vector3D far_bottom_left_point = new Vector3D(-semi_width, -semi_height, z_far);
            ...
            Vector3D right_normal = Vector3D.Normal_From_Plane(near_top_right_point, far_top_right_point, far_bottom_right_point); //notnecessary
