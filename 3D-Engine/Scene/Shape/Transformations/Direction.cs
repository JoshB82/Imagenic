namespace _3D_Engine
{
    public static partial class Transform
    {
        ...
        public static Vector3D Calculate_Direction_Forward(Vector3D direction_up, Vector3D direction_right) => direction_up.Cross_Product(direction_right);
        /// <summary>
        ...
        public static Vector3D Calculate_Direction_Up(Vector3D direction_right, Vector3D direction_forward) => direction_right.Cross_Product(direction_forward);
        /// <summary>
        ...
        public static Vector3D Calculate_Direction_Right(Vector3D direction_forward, Vector3D direction_up) => direction_forward.Cross_Product(direction_up);
    }
}