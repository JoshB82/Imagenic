...
namespace _3D_Engine.Entities.SceneObjects.Meshes.Components.Faces
{
    ...
    public sealed class SolidFace : Triangle
    {
        ...
        internal SolidFace(Vector4D p1, Vector4D p2, Vector4D p3) => (P1, P2, P3) = (p1, p2, p3);

        public SolidFace(Vertex modelP1, Vertex modelP2, Vertex modelP3) => (ModelP1, ModelP2, ModelP3) = (modelP1, modelP2, modelP3);
